...
void Thuc_Linh(List pL) {
    ...
    while (p != NULL) {
        ...
        p = p->next;
                                                ...
                                                //BẢNG THỐNG KÊ SỐ LIỆU THEO ĐƠN VỊ
...
int main(){
    ...
    switch(x) {
        ...
        case 5:
            Thuc_Linh(pL);
            system("cls");
            printf("BANG TONG KET THEO DON VI: \n");
        ...
        case 11:
            system("cls");
            char newfile[100];
            printf("Nhap dia chi file can luu: ");
            scanf("%s", &newfile);
...
// chinh sua trong file, luu list da thao tac vao file moi     D:\PBL1\file.txt
